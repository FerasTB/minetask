...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::get('office/coa/doctor-summary', [App\Http\Controllers\Api\COAController::class, 'indexForEmployee']);
    Route::get('office/{office}/coa/with-date', [App\Http\Controllers\Api\COAController::class, 'indexOwnerWithDate']);
    ...
    Route::post('invoices/{invoice}/reverse', [App\Http\Controllers\Api\InvoiceController::class, 'reverseInvoice']);
    Route::post('receipts/{receipt}/reverse', [App\Http\Controllers\Api\ReceiptController::class, 'reverseReceipt']);
...
Route::group(['middleware' => ['auth:sanctum', 'isDentalLab']], function () {
    ...
    Route::get('dental/lab/{lab}/all/users', [DentalLabController::class, 'allUsers']);
    Route::get('dental/lab/{lab}/add/user/{patient}', [DentalLabController::class, 'addEmployee']);
    Route::get('dental/lab/{lab}/prefix', [DentalLabControlle::class, 'indexPrefix']);
});
